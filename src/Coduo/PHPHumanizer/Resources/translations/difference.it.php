...
return  [
    ...
    'second' => [
        'past' => '[0,1] %count% secondo fa|[2,Inf] %count% secondi fa',
        'future' => '[0,1] %count% secondo da adesso|[2,Inf] %count% secondi da adesso',
    ],
    'minute' => [
    ...
    'compound' => [
        'second' => '[0,1] %count% secondo|[2,Inf] %count% secondi',
